...
client.on('message_create', async (message) => {
  ...
  if (typeof message.body === 'string') {
    ...
    // Segue com o processamento do comando
    if (msg === '/ping') {
  ...
  if (command === 'menu') {
    ...
    const media = MessageMedia.fromFilePath('./midia/menu.jpg'); // Coloque a imagem aqui
...
if (command === '') {
  ...
  console.warn('⚠️ Mensagem recebida sem corpo de texto válido:', message);
}
